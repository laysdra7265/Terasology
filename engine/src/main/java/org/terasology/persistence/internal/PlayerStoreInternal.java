...
import org.terasology.logic.players.PlayerEntityRestorer;
...
final class PlayerStoreInternal implements PlayerStore {
    ...
    @Override
    public void restoreEntities(EntityRef controller) {
        if (entityStore != null) {
            PlayerEntityRestorer restorer = new PlayerEntityRestorer(entityManager,controller);
