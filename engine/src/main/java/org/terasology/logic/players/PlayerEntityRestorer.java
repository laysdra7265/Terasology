...
final public class PlayerEntityRestorer {
    private EngineEntityManager entityManager;
    private EntityRef controller;
    public PlayerEntityRestorer(EngineEntityManager entityManager,EntityRef controller) {
        this.entityManager = entityManager;
        this.controller = controller;
    }

    public Map<String, EntityRef> restore(EntityData.EntityStore store) {
        EntitySerializer serializer = new PlayerEntitySerializer(entityManager,controller);
